const api = {
  ...
  merchants: [
    ...
    },
    {
      ...
      isOpen: "N",
      highlightText:
        "ร้านนี้ไม่ค่อยมีอะไรขาย เน้นขายขำเป็นหลัก <strong>มีที่จอดรถ</strong>",
...
exports.api = api;
exports.api_categories = api.categories;
exports.api_provinces = api.provinces;
exports.api_priceRange = api.priceRange;